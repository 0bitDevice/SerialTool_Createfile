...
BOOL RT_COM::Open(DWORD dwPortNo, DWORD dwBaud, BYTE ByteSize /*= 8*/, BYTE Parity /*= NOPARITY*/, BYTE StopBits /*= ONESTOPBIT*/)
{
	TCHAR sCom[20] = _T("\\\\.\\COM");
	TCHAR szPortNo[3];

	_itot(dwPortNo, szPortNo, 10);
	_tcscat(sCom, szPortNo);
